...
const IncomingOrdersPage = ({ allOrders, updateOrderStatus }) => {
  ...
  return (
    <div className="container mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <span className="text-lg font-semibold bg-blue-100 text-blue-800 rounded-full px-4 py-1">
      ...
      {filteredOrders.length > 0 ? (
        ...
        <div className="text-center text-gray-500 p-10 bg-white rounded-lg shadow">
          <p className="text-lg">No incoming orders match your criteria.</p>
        </div>
      )}
    </div>
  );
