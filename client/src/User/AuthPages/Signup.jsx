...
const InputField = ({
  ...
  <div className="mb-4">
    ...
    <input
      ...
      // Tailwind class for rounded corners and focus styles
    />
    {errors[name] && (
...
const SignUpForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        ...
        alert("Registration Successful! Welcome to Feasty!");
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-8 flex justify-center items-center">
      <div className="w-full max-w-md bg-white shadow-2xl rounded-xl p-8 pt-4 md:p-6 transform hover:scale-[1.01] transition-transform duration-300">
        {/* Header */}
